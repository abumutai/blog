                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('articles.update',$article->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{old('title')==null ? $article->title : old('title')}}" required autocomplete="title" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <option value="local" {{$article->category=='local'?'selected':''}}>Local News</option>
